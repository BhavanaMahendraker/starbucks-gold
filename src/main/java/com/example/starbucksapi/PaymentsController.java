...
public class PaymentsController {  
    ...
    @Autowired
    private final PaymentsCommandRepository repository;
    ...
    public String postAction(@Valid @ModelAttribute("command") PaymentsCommand command,  
        ...
        */
        ...
        newcmd.setLastname(command.getLastname());
        newcmd.setAddress(command.getAddress());
        newcmd.setCity(command.getCity());
        newcmd.setState(command.getState());
        newcmd.setZip(command.getZip());
        newcmd.setPhonenumber(command.getPhonenumber());
        newcmd.setCardnumber(command.getCardnumber());
        newcmd.setExpmonth(command.getExpmonth());
        newcmd.setExpyear(command.getExpyear());
        newcmd.setCvv(command.getCvv());
        newcmd.setEmail(command.getEmail());

        repository.save(newcmd);
        */
